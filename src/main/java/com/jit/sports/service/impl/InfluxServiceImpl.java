...
public class InfluxServiceImpl implements InfluxService {
    ...
    @Override
    public void insertLocationProcessedMsg(List<MyLatLngPoint> dd, String sportTag) {
//        influxDao.insertLocationProcessedMsg(sportTag, longitude, latitude);
        for (int i=0;i<dd.size();i++)
        {
            influxDao.insertLocationProcessedMsg(sportTag,
                    dd.get(i).getLongitude(),dd.get(i).getLatitude());
        }
    }
